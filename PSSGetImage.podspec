...
Pod::Spec.new do |s|
  s.name             = 'PSSGetImage'
  s.version          = '0.1.0'
  s.summary          = 'A short description of PSSGetImage.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/彭盛凇/PSSGetImage'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '彭盛凇' => 'shengsongpeng@huangbaoche.com' }
  s.source           = { :git => 'https://github.com/彭盛凇/PSSGetImage.git', :tag => s.version.to_s }
